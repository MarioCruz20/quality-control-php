...
@section('title', 'Editar Parámetros de Calidad')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-8">
            ...
            <!-- Título -->
            <div class="mb-8">
                <h1 class="font-nav text-2xl font-bold text-gray-900">Editar Parámetros de Calidad</h1>
                <p class="text-sm text-gray-500 mt-1">
                    Modifica los valores de control de calidad asociados al producto.
                </p>
            </div>

            <form action="{{ route('qualityparameters.update', $qualityParameters->quality_parameter_id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="isactive" value="Y"
                                    {{ $qualityParameters->isactive == 'Y' ? 'checked' : '' }}
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="isactive" value="N"
                                    {{ $qualityParameters->isactive == 'N' ? 'checked' : '' }}
